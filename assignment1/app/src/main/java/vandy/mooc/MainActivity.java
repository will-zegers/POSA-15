...
public class MainActivity extends LifecycleLoggingActivity {
    ...
    public void downloadImage(View view) {
        try {
            ...
            // method.
            // @@ TODO -- you fill in here.
            String urlString = downloadImageIntent.getDataString();
            if (urlString != null) {
                Intent chooser = Intent.createChooser(downloadImageIntent, "Open with");
    ...
    protected void onActivityResult(int requestCode,
        ...
        if (RESULT_OK == resultCode) {
            ...
            if (DOWNLOAD_IMAGE_REQUEST == requestCode) {
                ...
                // file.
                // @@ TODO -- you fill in here.
                Intent galleryIntent = makeGalleryIntent("file://"+data.getDataString());
        ...
        // Check if the started Activity did not complete successf  ully
        ...
        // code.
            ...
            Toast.makeText(
                    ...
                    "A problem occurred when trying to " +
                            "download contents at the given URL",
                    Toast.LENGTH_LONG)
                    .show();
        }
    ...
    private Intent makeGalleryIntent(String pathToImageFile) {
        ...
        return new Intent()
                ...
                .setDataAndType(Uri.parse(pathToImageFile), "image/jpeg");
    }
